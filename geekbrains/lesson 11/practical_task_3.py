# Создайте модуль ex_1-2.py. Из модулей реализованных в заданиях 1 и 2 сделайте импорт в ex_1-2.py всех функций.
# Вызовите каждую функцию в ex_1-2.py и проверьте что все работает как надо.
