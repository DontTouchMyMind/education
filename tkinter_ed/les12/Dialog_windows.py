...
btn1 = Button(root, text='Info', font=('Ubuntu', 20),
              command=lambda: showinfo('ShowInfo', 'Информация'))
btn1.grid(row=0, column=0, sticky='ew')
btn2 = Button(root, text='Warning', font=('Ubuntu', 20),
              command=lambda: showwarning('ShowWarning', 'Предупреждение'))
btn2.grid(row=1, column=0, sticky='ew')
btn3 = Button(root, text='Error', font=('Ubuntu', 20),
