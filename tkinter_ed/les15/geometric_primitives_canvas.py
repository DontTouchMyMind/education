...
c1.create_line(250, 0, 250, 500, width=3, fill='red', arrow=BOTH)
c1.create_line(0, 250, 500, 250, width=3, fill='blue', arrow=LAST)
...
c1.create_text(275, 330, text='Tkinter \nis the program\n with window interface', font=('Verdana', 12), anchor='w',
